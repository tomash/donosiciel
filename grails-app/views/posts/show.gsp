                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:postInstance, field:'createdAt')}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name">Participation:</td>
                            
                            <td valign="top" class="value"><g:link controller="participation" action="show" id="${postInstance?.participation?.id}">${postInstance?.participation?.encodeAsHTML()}</g:link></td>
